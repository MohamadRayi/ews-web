...
import { Droplet, Battery, Thermometer, Gauge } from "lucide-react";
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <Thermometer className="h-4 w-4 text-ews-red" />
          </CardHeader>
          <CardContent>
            <div className="text-3xl font-bold">{sensorData.temperature}°C</div>
            <p className="text-xs text-muted-foreground">Suhu lingkungan sekitar sensor</p>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            ...
            <Gauge className="h-4 w-4 text-ews-blue" />
          </CardHeader>
          <CardContent>
            <div className="text-3xl font-bold">{sensorData.humidity}%</div>
            <p className="text-xs text-muted-foreground">Kelembaban lingkungan sekitar</p>
          </CardContent>
        </Card>
      </div>
